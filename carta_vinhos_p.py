...
def main():
    ...
    # NOVO: Botão "Carregar logo clientes" logo abaixo do código (primeiro markdown)
    ...
    # --- Resto da função main permanece exatamente igual ao original ---

    # ... (todo o restante igual ao seu código original)
